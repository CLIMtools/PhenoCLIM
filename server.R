...
shinyServer(function(input, output) {
      ...
      output$map <- renderLeaflet({
        ...
        leaflet(FULL) %>% 
          ...
          addLayersControl(baseGroups = c('Esri.WorldImagery',"OpenStreetmap","OpenTopoMap","Esri.WorldGrayCanvas","Esri.NatGeoWorldMap","Esri.OceanBasemap",'DarkMatter (CartoDB)' ),
     ...
     df <- datasets[['FULL']]
      ...
      output$yvar <- renderUI(selectInput('yvar',label='Environment',choices =  list("NASA: MOD11C3"= c("Land Temp day spring (°C)"="LTemp day spring (°C)",	"Land Temp day summer (°C)" = "LTemp day summer (°C)",	"Land Temp night spring (°C)" = "LTemp night spring (°C)",	"Land Temp night summer (°C)" = "LTemp night summer (°C)"), "Coordinates" = c("Longitude (degrees)"="lng", "Latitude (degrees)"="lat"),"Physical terrain"= c("USGS:GTOPO30 Topography (m)", "NASA: SRTM elevation (m)","Bedrock topography (meters)",	"Distance to the coast (Km)"), "NASA: MOPITT" = c("CO Spring (ppbv)" , "CO Summer (ppbv)"), "NASA: OMI"= c("NO2 Spring (billion molecules/mm2)", "NO2 Summer (billion molecules/mm2)",	"O3 Spring (Dobson Units)",	"O3 Summer (Dobson Units)",
                                                                                                  ...
                                                                                                  "NASA: MOD13Q1" =c("NDVI Spring",	"NDVI Summer"),"NASA: MOD15A2"=c("LAI Spring (m2/m2)","LAI Summer (m2/m2)"),"NASA: MOD16A2"=c("Potential evaporation (mm/yr)"="PET (mm/yr)","Evaporation (mm/yr)" ="ET (mm/yr)",
      ...
      output$xvar <- renderUI(selectInput('color',label='Phenotype',choices = list("1001 Genomes Project"=c("Flowering time at 10 °C (days)",	"Flowering time at 16 °C (days)"),
                                                                                   "Vasseur et. al. PNAS 2018"=c("Lifespan (days)",	"Fruit number",	"Relative growth rate (mg d-1 g-1)", "Rosette dry mass (mg)",	"Absolute growth rate (mg d-1)", 	"Scaling exponent"),
                                                                                   "Meijón et. al. Nature Genetics 2014"=c("Mature cell length (µm)",	"Meristem zone length (µm)"),	
                                                                                                           "Satbhai et. al. Nature Communications 2017" = c("Root length Day 1 (mm)", "Root length Day 2 (mm)", "Root length Day 3 (mm)",	"Root length Day 4 (mm)",	"Root length Day 5 (mm)"),
                                                                                   "Li et. al. PNAS 2010"= c("Area Sweden 2009 1st experiment (cm2)","Area Sweden 2009 2nd experiment (cm2)",
                                                                                                          "Flowering time Spain 2008 1st experiment (Days)", 	"Flowering time Spain 2008 2nd experiment (Days)","Flowering time Spain 2009 1st experiment (Days)", "Flowering time Spain 2009 2nd experiment (Days)",
                                                                                                          "Flowering time Sweden 2008 1st experiment (Days)",	"Flowering time Sweden 2008 2nd experiment (Days)", "Flowering time Sweden 2009 1st experiment (Days)", "Flowering time Sweden 2009 2nd experiment (Days)",
                                                                                                          "Size Spain 2009 1st experiment (cm)",	"Size Spain 2009 2nd experiment (cm)",
                                                                                                          "Size Sweden 2009 1st experiment (cm)","Size Sweden 2009 2nd experiment (cm)",
                                                                                                          "Yield Spain 2009 1st experiment (g)", "Yield Spain 2009 2nd experiment (g)",	
                                                                                                          "Yield Sweden 2009 1st experiment (g)",	"Yield Sweden 2009 2nd experiment (g)",	
                                                                                                          "Yield Planting Summer 2009 (g)",
                                                                                                          "Yield Loc Sweden 2009 (g)",	"Yield Main Effect 2009 (g)",	
                                                                                                          "Yield Planting Summer Loc Sweden 2009 (g)"),
                                                                                   "Strauch et. al. PNAS 2015"=c("M216T665",	"M130T666",	"M172T666"),
                                                                                  
                                                                                  
                                                                                  "Atwell et. al, Nature 2010: Ionomics"=c("As75 (µg g-1 DW)"="As75 Atwell et. al. (µg g-1 DW)", 	"B11 (µg g-1 DW)"="B11 Atwell et. al. (µg g-1 DW)","Ca43 (µg g-1 DW)"="Ca43 Atwell et. al. (µg g-1 DW)","Co59 (µg g-1 DW)"="Co59 Atwell et. al. (µg g-1 DW)","Cu65 (µg g-1 DW)"="Cu65 Atwell et. al. (µg g-1 DW)",  "K39 (µg g-1 DW)"="K39 Atwell et. al. (µg g-1 DW)", "Li7 (µg g-1 DW)"="Li7 Atwell et. al. (µg g-1 DW)",	
                                                                                                                           "Mg25 (µg g-1 DW)"="Mg25 Atwell et. al. (µg g-1 DW)", "Mn55 (µg g-1 DW)"="Mn55 Atwell et. al. (µg g-1 DW)","Mo98 (µg g-1 DW)"="Mo98 Atwell et. al. (µg g-1 DW)", "Na23 (µg g-1 DW)"="Na23 Atwell et. al. (µg g-1 DW)", "Ni60 (µg g-1 DW)"="Ni60 Atwell et. al. (µg g-1 DW)",	"P31 (µg g-1 DW)"="P31 Atwell et. al. (µg g-1 DW)",	"S34 (µg g-1 DW)"="S34 Atwell et. al. (µg g-1 DW)", "Se82 (µg g-1 DW)"="Se82 Atwell et. al. (µg g-1 DW)",	"Zn66 (µg g-1 DW)"="Zn66 Atwell et. al. (µg g-1 DW)"),
                                                                                  
                                                                                  
                                                                                  
                                                                                 
                                                                                  "Atwell et. al, Nature 2010: Developmental"=c("Fresh Weight (g)", "Dry Weight (g)",
                                                                                                                                "Seed dormancy (days)", 
                                                                                                                                "Germination at 10°C (days)","Germination at 16°C (days)","Germination at 22°C (days)",
                                                                                                                                "Seedling growth rate (cm2/day)", "Vegetative growth rate during vernalization (%)", "Vegetative growth rate after vernalization (%)", "Secondary dormancy (%)",	"Germination in the dark after cold exposure (%)","DSDS50 (days)","Primary dormancy after 7 days of dry storage (%)","Primary dormancy after 28 days of dry storage (%)", "Primary dormancy after 56 days of dry storage (%)", "Hypocotyl length (cm)",
                                                                                                                                "Diameter at 10 °C (cm)", "Diameter at 22 °C (cm)",
                                                                                                                                "Silique lenght at 16°C (cm)","Silique lenght at 22°C (cm)",
                                                                                                                                "Flowering period (days)","Life cycle period (days)", "Last flower senescence (days)", "Maturation (days)", "Reproduction period (days)"),
                                                                                  
                                                                                   "Atwell et. al, Nature 2010: Flowering"=c("Flowering time long days/no vernalization (days)","Flowering time long days and vernalization (days)",	"Flowering time short days/no vernalization (days)", "Flowering time long days and vernalization (days)",
                                                                                   "Flowering time after 0 weeks of vernalization (days)",	"Flowering time after 2 wks of vernalization (days)",	"Flowering time after 4 wks of vernalization (days)",	"Flowering time after 8 wks of vernalization (days)",
                                                                                   "FLC gene expression levels", "FRI gene expression levels",                   	
                                                                                   "Flowering time at 10°C (days)", "FT time at 16°C (days)","Flowering time at 22°C (days)","Leaf number at 10°C", "Leaf number at 16°C", "Leaf number at 22°C",
                                                                                   "FT, no vernalization (Greenhouse)", "FT, 8 wks vernalization (Greenhouse)", "Leaf number, no vernalization (Greenhouse)", "Leaf number, 8 wks vernalization (Greenhouse)",  
                                                                                   "Flowering time in the field (days)",  "plant diameter in the field (cm)",	"Flowering time in the greenhouse (days)"),
                                                                                   
                                                                                  
                                                                                   
                                                                                   "Atwell et. al, Nature 2010: Resistance"=c("Trichome density Control",	"Trichome density JA","Bacterial titers of P. syringae (CFUs)", "Aphid number",
                                                                                   "P. viridiflava strain As2 severity (CFU)","P. viridiflava strain At1 severity (CFU)",	"P. viridiflava strain At2 severity (CFU)","P. viridiflava strain Bs severity (CFU)", 
                                                                                   "P. viridiflava strain As growth (CFU)", "P. viridiflava strain As2 growth (CFU)","P. viridiflava strain At1 growth (CFU)","P. viridiflava strain Bs growth (CFU)"),
                                                                                   
                                                                                   
                                                                                  
                                                                                   "David Salt: Ionomics"=c("As75 (µg g-1 DW)", "Ca43 (µg g-1 DW)",	 "Cd111 (µg g-1 DW)",	 "Cd114 (µg g-1 DW)",	"Co59 (µg g-1 DW)",	"Cu65 (µg g-1 DW)",	"Fe56 (µg g-1 DW)",	 "Fe57 (µg g-1 DW)",	"K39 (µg g-1 DW)", "Li7 (µg g-1 DW)",	"Mg25 (µg g-1 DW)",	"Mn55 (µg g-1 DW)", "Mo98 (µg g-1 DW)", "Ni60 (µg g-1 DW)", "Na23 (µg g-1 DW)", "P31 (µg g-1 DW)", "Rb85 (µg g-1 DW)",	"S34 (µg g-1 DW)", "Se82 (µg g-1 DW) ","Zn66 (µg g-1 DW)")
